...
const HeroSection = () => {
    return (
        <div
            ...
            {/*            />*/}
            {/*            <p className="text-xl text-muted-foreground">Explore the stunning transformation of the world's most iconic cultural sites. From ruins to restoration — see history rewritten, one building at a time.</p>*/}
